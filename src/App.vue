...
import profileImg from '@/assets/imgs/logo ob.svg'
</script>
...
<template>
  <div class="min-h-screen w-full grid grid-rows-[auto_1fr_auto] text-white custom-bg">
      ...
      <div class="wrapper w-full px-4 grid grid-cols-12 gap-0">
        <nav class="col-span-12 md:col-start-2 md:col-span-10 grid grid-cols-3 items-center py-2 gap-10">
          ...
          <div class="flex justify-end pr-8">
            <RouterLink to="/contact" class="nav-link hover:text-gold font-semibold">Kontakt</RouterLink>
          </div>
        </nav>
      </div>
    </header>
    ...
    <footer class="w-full bg-moss text-center py-4 mt-4 text-white-85">
      <span>&copy;</span>
    </footer>
  </div>
</template>
...
.nav-shell {
  ...
  background: linear-gradient(180deg, rgba(244, 244, 242, 0.06), rgba(244, 244, 242, 0.02));
  box-shadow: 0 8px 24px rgba(0, 0, 0, 0.22), inset 0 0 0 1px rgba(244, 244, 242, 0.08);
}

nav a.router-link-exact-active {
  color: var(--color-gold);
  background-color: rgba(184, 155, 79, 0.14);
  box-shadow: inset 0 0 0 1px rgba(184, 155, 79, 0.45), 0 0 18px rgba(184, 155, 79, 0.18);
}
